...
- Target Role: Applied AI Engineer (Agentic Systems Path)
- Location: City, State
...
Applied AI engineer preparing a robust foundation for agentic systems by implementing model internals, evaluation rigor, and scalable experimentation workflows.

## Role Focus

- LLM/agentic architecture understanding from fundamentals
- Experiment cards, ablations, and reproducibility
- Engineering path from toy systems to production-grade behavior
