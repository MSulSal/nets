...
- Target Role: ML Research Engineer (Foundations)
- Location: City, State
...
Research-oriented engineer building neural-network systems from first principles, with emphasis on mathematical correctness, reproducibility, and mechanism-level analysis.

## Role Focus

- Autograd correctness and gradient verification
- Small mechanism-isolating experiments
- Paper-to-code translation with transparent assumptions
